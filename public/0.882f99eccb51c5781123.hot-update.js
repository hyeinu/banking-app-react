	...
	var TransactionTable = _react2.default.createClass({
	  ...
	  render: function render() {
	    var productItems = this.props.list.map(function (item) {
	      return _react2.default.createElement(_Transaction2.default, { item: item, key: item._id });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!locales[name]&&typeof module!=='undefined'&&module&&module.exports){try{oldLocale=globalLocale._abbr;__webpack_require__(496)("./"+name);// because defineLocale currently also sets the global locale, we
