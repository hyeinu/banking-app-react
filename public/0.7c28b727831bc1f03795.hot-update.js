...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditForm = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./EditForm\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  render: function render() {
	    if (this.state.transactionslist.length) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_EditForm2.default, { show: this.state.editShow, update: this.onUpdate, editObj: this.state.editObj }),
