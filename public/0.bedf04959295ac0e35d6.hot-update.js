...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _react2.default.createClass({
	  ...
	  setStateChange: function setStateChange(data) {
	    var sum = data.reduce(function (sum, next) {
	  ...
	  onAdd: function onAdd(transaction) {
	    ...
	    fetch('/api/banktrans', {
	      ...
	      return _this2.setState({ transactionlist: _this2.state.transactionlist.concat(data) });
	    }).then(function () {
	      _this2.setStateChange(_this2.state.transactionlist);
	    }).catch(function (err) {
	      return err;
	      console.log('No Transaction Found', err);
	    });
